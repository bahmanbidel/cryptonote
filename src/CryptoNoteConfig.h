...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x16fa; // addresses start with "ir"
...
const char     CRYPTONOTE_NAME[]                             = "irancoin";
...
const int      P2P_DEFAULT_PORT                              = 17186;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 17226;
